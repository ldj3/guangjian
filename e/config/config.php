...
$ecms_config['db']['dbusername']='GUANGJIAN';	//数据库用户名
$ecms_config['db']['dbpassword']='dsafSDF#@3A.';	//数据库密码
$ecms_config['db']['dbname']='guangjian';	//数据库名
...
//后台安全设置
$ecms_config['esafe']['loginauth']='dengyi';	//登录认证码,如果设置登录需要输入此认证码才能通过
$ecms_config['esafe']['ecookiernd']='K9kWNWbhPzS7MSa4qadxfWxhAzXjdS';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='hpaiy';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='ktuwn';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='rBIWnNySYTibydZLjriO0PB9Cktgha';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='5c3dy54owL9jqZbLPj9yzpTICcAYFP';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
...
//------------e_public
$public_r=array('sitename'=>'广州市广建水泥制品有限公司--全国唯一官方网站',
'newsurl'=>'/',
...
'keytog'=>2,
'keytime'=>30,
'keyrnd'=>'pCeuYWEd04QuoUDT1TDEigEd6sbEjr',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/about/\">关于广建</a>&nbsp;|&nbsp;<a href=\"/case/\">工程案例</a>&nbsp;|&nbsp;<a href=\"/news/\">公司新闻</a>&nbsp;|&nbsp;<a href=\"/product/\">产品展示</a>&nbsp;|&nbsp;<a href=\"/contactus/\">联系我们</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
...
'modmemberedittran'=>0,
'modinfoedittran'=>0,
'deftempid'=>0,'add_footer'=>'电话：020-39965653 (广建水泥制品有限公司) &nbsp;&nbsp;&nbsp;&nbsp;   厂址：广州市番禺区石基镇凌边村凌环西路砖厂侧 <br />
Copyright@ 2016&nbsp;&nbsp;&nbsp;    广州市广建水泥制品有限公司-全国唯一官方网站 &nbsp;&nbsp;&nbsp; All rights reserved.   <br />
www.gz-guangjian.com&nbsp;&nbsp;&nbsp;&nbsp;  粤ICP备16111660号 <br />
<br />
<script>
var _hmt = _hmt || [];
(function() {
  var hm = document.createElement(\"script\");
  hm.src = \"https://hm.baidu.com/hm.js?27e6d8bc167c94351d039d60a1e50e29\";
  var s = document.getElementsByTagName(\"script\")[0]; 
  s.parentNode.insertBefore(hm, s);
})();
</script>

','add_index_news'=>'随着水泥行业的发展，水泥制品的装备产业群也日趋完善，广州市广建有限公司主营产品：环保彩砖|透水砖|建菱砖|路面砖|广场砖|植草砖|电缆沟盖板|电力盖板|水泥隔离墩|水泥防撞墩|交通隔离墩|仿花岗岩路侧石|水泥排水管|钢筋混凝土排水管|路侧石|预制件|球墨铸铁井盖','add_index_product'=>'广州市广建水泥制品有限公司专注研发、生产、销售的产品：环保彩砖|透水砖|建菱砖|路面砖|广场砖|植草砖|电缆沟盖板|电力盖板|水泥隔离墩|水泥防撞墩|交通隔离墩|仿花岗岩路侧石|水泥排水管|钢筋混凝土排水管|路侧石|预制件|球墨铸铁井盖','add_index_aboutus'=>'广州市广建水泥制品有限公司位于闻名的羊城拥有美吃之称的广州市番禺区石基镇，以生产、销售为一体的企业，公司主要生产、销售：环保彩砖,透水砖,建菱砖，路面砖，广场砖，植草砖，电缆沟盖板，电力盖板，水泥隔离墩，水泥防撞墩，交通隔离墩，仿花岗岩路侧石，水泥排水管，钢筋混凝土排水管，路侧石，预制件，球墨铸铁井盖等水泥制品，一直以国家严格监控的标准为质量标准，做良心的工程在市场上一直广受表彰。广州市广建在广东省珠三角市政建设和房地产建设中，发挥着重要作用，我司目前已具有开发各种水泥制品、水泥构件的能力同技术力量，能按广大客户要求，进行各种水泥制品、水泥构件的设计，并可以到各工程公司、制梁厂直接生产我厂依托先进的设备、成熟的工艺技术，多年以质量为第一，诚信为宗旨，愿同广大的新老客户在以后的发展中越做越辉煌。

广州市广建服务客户：
      万科地产、保利地产、万达地产、和黄地产、恒大地产、越秀地产、富力地产、合生珠江、珠光地产、香港合景地产、广州普邦园林、广州华苑园林、棕榈园林、东篱园林、深圳城基园林、深圳文科园林、东莞岭南园林......
','add_contactus'=>' <img src=\"http://www.gz-guangjian.com/skin/guangjian/upload/a840970c9f5d62e24afc5d088fa6f516.jpg\" alt=\"联系我们\" style=\"width:960px;\"/><br/>
                        <br/>
                        公司名：广州市广建水泥制品有限公司 <br/>
                        电话：020-39965653 <br/>
                        邮编：510000 <br/>
                        厂址：广州市番禺区石基镇凌边村凌环西路砖厂侧','add_site_name'=>'广州市广建水泥制品有限公司--全国唯一官方网站');
//------------e_public
...
'definfovoteid'=>0,
'orderf'=>'',
'sonclass'=>'|87|97|73|74|75|76|77|78|79|81|82|83|84|85|88|90|91|92|93|94|96|95|',
'tid'=>1,
'tbname'=>'news');
