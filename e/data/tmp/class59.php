...
<title>关于广建--<?=$public_r['add_site_name']?></title>
...
$classurl=sys_ReturnBqClassname($bqr,9);//取得栏目地址
?>
 <li class="<?=$c_now?>"><a href="<?=$classurl?>" title="<?=$class_r[$bqr[classid]]['classname']?>"><?=$class_r[$bqr[classid]]['classname']?></a></li>
 <?php
}
}
?> 
        ...
        <div class="main_box_right">
            <div class="current_location current_location_564">
                <ul>
                    <li class="current_location_1"><a href="/">首页</a>&nbsp;>&nbsp;<a href="/about/">关于广建</a></li>
